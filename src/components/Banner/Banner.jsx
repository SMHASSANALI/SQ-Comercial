    ...
    <section id="Home" className="flex items-center justify-center bg-charcoalPrimary min-h-[80vh] py-12">
      <div className="flex flex-col md:flex-row max-w-[1400px] justify-center items-center px-4">
        <div className="flex flex-col justify-center w-full md:w-6/12">
          <h1 className="text-3xl md:text-6xl font-bold text-white mb-8 md:max-w-2xl">
            From Civil Engineering to Fiber Optics,<br /> We Build it All.
          </h1>
          <p className="text-white text-lg font-light mb-16 md:max-w-xl">
            SQ Commercial Services provides expert consultancy to develop innovative
            strategies that drive sustainable growth and long-term success for our clients.
          </p>
